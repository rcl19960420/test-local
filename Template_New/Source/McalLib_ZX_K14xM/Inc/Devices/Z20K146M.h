...
#define Z20K146M_H_VENDOR_ID                   0x00B3U
#define Z20K146M_H_AR_RELEASE_MAJOR_VERSION    4U
#define Z20K146M_H_AR_RELEASE_MINOR_VERSION    6U
#define Z20K146M_H_AR_RELEASE_REVISION_VERSION 0U
#define Z20K146M_H_SW_MAJOR_VERSION            1U
#define Z20K146M_H_SW_MINOR_VERSION            2U
#define Z20K146M_H_SW_PATCH_VERSION            1U

#ifdef MCAL_INTER_MODULE_ASR_CHECK_ENABLE
    #if ((Z20K146M_H_AR_RELEASE_MAJOR_VERSION != PLATFORM_TYPES_AR_RELEASE_MAJOR_VERSION) ||       \
         (Z20K146M_H_AR_RELEASE_MINOR_VERSION != PLATFORM_TYPES_AR_RELEASE_MINOR_VERSION))
        #error "AUTOSAR Version of Z20K146M.h and Platform_Types.h and are different"
    #endif
#endif
...
#define FLASH_CODE_END_ADDR  ((uint32)0x000FFFFFU) /*!< program/Code flash end address */
